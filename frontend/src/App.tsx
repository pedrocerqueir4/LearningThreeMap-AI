        ...
        <div className="sidebar-header">
          <div className="sidebar-header-top">
            <h1 className="app-title">
              {isSidebarCollapsed ? 'LF' : 'LearningFlow'}
            </h1>
          </div>
          <div className="sidebar-actions">
            <button className="primary-button" onClick={handleNewConversation} disabled={loading}>
              ...
              {!isSidebarCollapsed && <span className="primary-button-text">New conversation</span>}
            </button>
            <button
              type="button"
            ...
            >
              ...
              {!isSidebarCollapsed && <span className="settings-button-text">Settings</span>}
            </button>
            <button
              type="button"
            ...
            >
              <span className="sidebar-toggle-button-icon">
                {isSidebarCollapsed ? (
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {!isSidebarCollapsed && <span className="sidebar-toggle-button-text">Hide</span>}
            </button>
          </div>
        </div>
              ...
              <div className="settings-modal-body">
                <div className="setting-section">
                  ...
                  <div className="theme-options">
                    <button
                      className={`theme-option theme-option--cyber ${colorTheme === 'cyber' ? 'theme-option--active' : ''}`}
